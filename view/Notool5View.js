            ...
            for (var k = 0; k < barr.length; k++) {
                for (var m = 0; m < barr.length; m++) {
                    for (var n = 0; n < barr.length; n++) {
                        retarr.push(barr[i] + barr[j] + barr[k] + barr[m] + barr[n]);
                    }
                }
            }
        }
...
var zhgjType = 5;
var itemspecial = ['不连', '2连', '3连', '4连', '5连', 'AAAAA', 'AABCD', 'AABBC', 'AAABB', 'AAABC', 'AAAAB', 'ABCDE'];
var bigsmallbi = ['0:5', '1:4', '2:3', '3:2', '4:1', '5:0'];
export default class Notool4View extends React.Component {
    ...
    clearSelect(type: string) {
        switch (type) {
            ...
            case 'sddz':
                ...
                this.refs.dxb.setSelected([]);
                this.refs.job.setSelected([]);
                this.refs.zhb.setSelected([]);
                break;
            case 'danzu':
    ...
    createNo() {
        var erXingArr = zhgj.wuXing();
        erXingArr = zhgj.danMa(erXingArr, this.refs.dm.getSelected());

        //杀定位
        erXingArr = zhgj.removeDingWei(erXingArr, this.refs.sdw1.getSelected(), 1);
        erXingArr = zhgj.removeDingWei(erXingArr, this.refs.sdw2.getSelected(), 2);
        erXingArr = zhgj.removeDingWei(erXingArr, this.refs.sdw3.getSelected(), 3);
        erXingArr = zhgj.removeDingWei(erXingArr, this.refs.sdw4.getSelected(), 4);
        erXingArr = zhgj.removeDingWei(erXingArr, this.refs.sdw5.getSelected(), 5);
        ...
        //大小比 奇偶比 质合比
        erXingArr = zhgj.bigSmallPercent(erXingArr, this.refs.dxb.getSelected());
        erXingArr = zhgj.oddEvenPercent(erXingArr, this.refs.job.getSelected());
        erXingArr = zhgj.primePercent(erXingArr, this.refs.zhb.getSelected());
            ...
            >
                ...
                <View>
                    ...
                    <View style={{flexDirection:'row'}}>
                        ...
                        <NotoolRowYiLouView
                            selected={this.state.omession.eCurrOmission.countList}
                        />
                    </View>
                </View>
                ...
                <View style={{flexDirection:'row',paddingBottom:5,alignItems:'center'}}>
                    <Text style={[styles.notool_text_left,{marginTop:0}]}>大小比</Text>
                ...
                <View style={{flexDirection:'row',paddingBottom:5,alignItems:'center'}}>
                    <Text style={[styles.notool_text_left,{marginTop:0}]}>奇偶比</Text>
                    <NotoolRowText2ViewOld
                        ref='job'
                        items={bigsmallbi}
                        title="奇偶比"
                ...
                <View style={{flexDirection:'row',paddingBottom:5,alignItems:'center'}}>
                    <Text style={[styles.notool_text_left,{marginTop:0}]}>质合比</Text>
                    <NotoolRowText2ViewOld
                        ref='zhb'
                        items={bigsmallbi}
                        title="质合比"
