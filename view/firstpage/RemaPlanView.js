...
class RemaPlanView extends React.Component {
            ...
            dataSource: ds.cloneWithRows([
                {
                    ...
                    "wei": "个位",
                    "planNum": "29160",
                    "resultNumber": "9,6,1,8,1",
                    "status": true,
                    "planName": null,
                    "itemIndex": 0,
                    "amount": 95.0,
                    "caipiaoList": [{"period": 20161230022, "result": "9,6,1,8,1"}],
                    "hotColdSubList": null
                }]),
            total: 0,
            loaded: false,
    ...
    formatPlanNumber(numstr: string) {
        ...
        // }
        //排序
        numarr = Utils.lodash.sortBy(strarr, function (n) {
            return n;
        });
        ...
        for (var i = 0; i < this.state.fvlist.length; i++) {
            fprView.push(
                <View style={styles.btjs_rowStyle} key={i}>
                    ...
                    <Text
                        style={[styles.plan_center_row_w,{marginLeft:10}]}>{this.state.fvlist[i].result ? this.state.fvlist[i].result : '等待开奖'}</Text>
                </View>
            )
        }
        return fprView;
                ...
                >
                    <View style={styles.jpp_hide_view}>
                        <TouchableHighlight
                            ...
                            <View
                                style={[styles.jpp_hide_view_btn,this.state.wf=='dw'&&styles.jpp_hide_view_btn_selected]}>
                                <Text
                                    style={[styles.jpp_hide_view_btn_text,this.state.wf=='dw'&&styles.jpp_hide_view_btn_text_selected]}>定位胆计划</Text>
                                {this.state.wf == 'dw' &&
                        ...
                        <TouchableHighlight
                            ...
                            <View
                                style={[styles.jpp_hide_view_btn,this.state.wf=='bdw'&&styles.jpp_hide_view_btn_selected]}>
                                <Text
                                    style={[styles.jpp_hide_view_btn_text,this.state.wf=='bdw'&&styles.jpp_hide_view_btn_text_selected]}>胆码计划</Text>
                                {this.state.wf == 'bdw' &&
                                <View style={styles.jpp_hide_view_under}></View>
                                }
                            </View>
                        ...
                        <TouchableHighlight
                            ...
                            <View
                                style={[styles.jpp_hide_view_btn,this.state.wf=='zux'&&styles.jpp_hide_view_btn_selected]}>
                                <Text
                                    style={[styles.jpp_hide_view_btn_text,this.state.wf=='zux'&&styles.jpp_hide_view_btn_text_selected]}>组选计划</Text>
                                {this.state.wf == 'zux' &&
                                <View style={styles.jpp_hide_view_under}></View>
                                }
                            </View>
                        ...
                        <TouchableHighlight
                            ...
                            <View
                                style={[styles.jpp_hide_view_btn,this.state.wf=='zhx'&&styles.jpp_hide_view_btn_selected]}>
                                <Text
                                    style={[styles.jpp_hide_view_btn_text,this.state.wf=='zhx'&&styles.jpp_hide_view_btn_text_selected]}>直选计划</Text>
                                {this.state.wf == 'zhx' &&
                                <View style={styles.jpp_hide_view_under}></View>
                                }
                            </View>
                    ...
                    <View style={styles.jpp_hide_view_fn}>
                        ...
                        <View style={styles.picker_view}>
                            {this.state.wf == 'bdw' ?
                                ...
                                <ModalPicker
                                    ...
                                    onChange={(option)=>{ this.setState({fn2_m:option.key});  Utils.setPickerSelect(data_m,option.key)}}/>
                            }
                        </View>
                        <View style={styles.picker_view}>
                            <ModalPicker
                        ...
                        <TouchableHighlight
                            ...
                            <View
                                style={{backgroundColor:'#ffaf48',borderRadius:3,width:66*Utils.scale,height:28*Utils.scale,borderWidth:1,marginRight:10,borderColor:'#ffaf48',justifyContent:'center',marginLeft:1,marginTop:1}}>
                    ...
                    <View style={{flexDirection:'row',justifyContent:'space-around',alignItems:'center'}}>
                        ...
                        <Text
                            style={{fontSize:13*Utils.scale,paddingVertical:10,color:'#ea5656',flex:1}}>{this.getWf_show()}>{this.getFn1_w_show()} {this.state.fn2_m}码 {this.fn3_q}期>(准确率:{this.state.winRate}%)</Text>
                    ...
                    <View style={{flexDirection:'row'}}>
                        ...
                        <View style={{marginLeft:5,flexDirection:'row',justifyContent:'space-around',flex:3}}>
                            <Text
                                style={{flex:2,marginLeft:10,alignSelf:'center',textAlign:'left',color:'#f00',fontSize:12*Utils.scale}}>{this.state.firstPlanResult ? this.formatPlanNumber(this.state.firstPlanResult) : '00000'}</Text>
                            <Text
                                style={{flex:1,alignSelf:'center',textAlign:'left',color:'#f00',marginRight:5,fontSize:12*Utils.scale}}>投注中...</Text>
                        </View>
                    </View>
                    }
                    <View style={styles.splitLine}></View>
