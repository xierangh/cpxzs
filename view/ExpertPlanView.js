    ...
    return(
      <View style={styles.container}>
        ...
        {this.state.isWf &&
          ...
          <TouchableHighlight
            ...
            <View style={styles.jpp_hide_view_btn}>
              <Text style={this.state.wf=='dw'&&{color:'#f00'}}>定位胆计划</Text>
            </View>
          </TouchableHighlight>
          <TouchableHighlight
            underlayColor={'#ea565630'}
            ...
            <View style={styles.jpp_hide_view_btn}>
              <Text style={this.state.wf=='bdw'&&{color:'#f00'}}>胆码计划</Text>
            </View>
          </TouchableHighlight>
          <TouchableHighlight
            underlayColor={'#ea565630'}
            ...
            <View style={styles.jpp_hide_view_btn}>
              <Text style={this.state.wf=='zux'&&{color:'#f00'}}>组选计划</Text>
            </View>
          </TouchableHighlight>
          <TouchableHighlight
            underlayColor={'#ea565630'}
            ...
            <View style={styles.jpp_hide_view_btn}>
              <Text style={this.state.wf=='zhx'&&{color:'#f00'}}>直选计划</Text>
            </View>
          </TouchableHighlight>
          </View>
        }
            ...
            <View style={styles.jpp_hide_view_fn}>
              ...
              <TouchableHighlight
                ...
                onPress={() => this.onfinish()}>
                  <View style={{backgroundColor:'#ffaf48',borderRadius:3,width:66,height:28,borderWidth:1,marginRight:10,borderColor:'#ffaf48',justifyContent:'center',marginLeft:1,marginTop:1}}>
                    <Text style={{textAlign:'center',color:'#fff'}}>完成</Text>
                  </View>
              </TouchableHighlight>
          </View>
        }
      ...
      {this.state.showPicker==3 &&
        ...
        <View style={{flexDirection:'row',justifyContent:'space-around',alignItems:'center'}}>
          <Text style={{fontSize:13,paddingVertical:10,marginLeft:10}}>选中:</Text>
          <Text style={{fontSize:13,paddingVertical:10,color:'#f00',flex:1}}>{this.getWf_show()}>{this.getFn1_w_show()} {this.state.fn2_m}码 {this.fn3_q}期>{this.state.planValue.jhfaName}({this.state.planValue.winRate}%)</Text>
        ...
        <View style={{flexDirection:'row'}}>
          ...
          <View style={{marginLeft:5,flexDirection:'row',justifyContent:'space-around',flex:3}}>
            <Text style={{flex:2,marginLeft:10,alignSelf:'center',textAlign:'left',color:'#f00',fontSize:12}}>{this.state.firstPlanResult?this.formatPlanNumber(this.state.firstPlanResult):'00000'}</Text>
            <Text style={{flex:1,alignSelf:'center',textAlign:'left',color:'#f00',marginRight:5,fontSize:12}}>投注中...</Text>
          </View>
        </View>
        }
        <View style={styles.splitLine}></View>
